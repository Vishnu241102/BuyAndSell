...
import Home2 from 'mdi-react/BedIcon'
import Home3 from 'mdi-react/CurtainsIcon'
...
export default function buy()
{
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            try
            {
                const res = await axios.get(`http://localhost:4000/getSellType?search=${inputValue}&category=${categoryFilter}&sort=${sortFilter}`);
    ...
    return(
        ...
        <div className={scrollY>40?"md:flex fixed shadow-2xl w-full z-40 top-0 mb-96 bg-white transition-colors duration-1000 ":"md:flex fixed w-full z-40 top-0 mb-96"}>
            <div className="flex justify-between items-center w-full h-16 font-bold ">
                <div className="md:pl-12 p-2 w-auto flex flex-row">
            ...
            <div className=' text-[#333333] text-[16px] font-sans flex flex-col font-medium rounded-lg'> 
                ...
                <div className='rounded-lg shadow-lg flex flex-row m-2 p-3 cursor-pointer border-2 border-slate-200'>
                    <div className='flex flex-row justify-between w-full'>
                        ...
                        <div className='pr-4'>
                            <SortPriceDesc color='#8A307F'/>
                        </div> 
                    </div>
                    <button className='cursor-pointer' onClick={() => handleSortChange('pHtL')}>
                        {sortFilter=="pHtL"?(
                            <div className='bg-blue-600 rounded-full'>
                               <Right size={20} color='white'/>
                            </div>
                ...
                <div className='rounded-lg shadow-lg flex flex-row m-2 p-3 cursor-pointer border-2 border-slate-200'>
                    <div className='flex flex-row justify-between w-full'>
                        ...
                        <div className='pr-4'>
                            <SortPriceAsc color='#8A307F'/>
                        </div> 
                    </div>
                    <button className='cursor-pointer' onClick={() => handleSortChange('pLtH')}>
                        {sortFilter=="pLtH"?(
                            <div className='bg-blue-600 rounded-full'>
                               <Right size={20} color='white'/>
                            </div>
        ...
        <div className="flex py-1 overflow-x-auto mt-16 scrollbar-hide shadow-lg">
            ...
            <div className={categoryFilter=="home"?'flex flex-col flex-shrink-0 md:mx-16 mx-6 px-2 py-2  border-y-blue-500 border-b-4 shadow-lg bg-gray-200 rounded-md':'flex flex-col flex-shrink-0 md:mx-16 mx-6 px-2 py-2'}>
                <button className='flex flex-col items-center' onClick={() => handleCategoryChange('home')}>
                    <div className='relative bg-slate-200 w-full'>
                        <Home1 className='absolute top-0 left-0' color='#8A307F'/>
                        <Home2 className='absolute top-2 left-6 z-20' color='#79A7D3'/>
                        <Home3 className='absolute top-6 left-2 z-30' color='#6883BC'/>
                    </div>
                ...
                <div className='flex flex-col justify-between h-full p-4'>
                    ...
                    <div className='bg-white rounded-2xl shadow-2xl h-auto flex flex-col w-full py-2'>
                        ...
                        <div className='flex flex-row py-2 px-4 item-center'>
                            <div className='text-lg px-3 py-1 text-white bg-[#8A307F] rounded-md shadow-2xl'>
                                ${fullItem.sPrice}
                            </div>
                            ...
                            <div className='ml-8'>
                                {fullItem.isNego=="yes"?(<div className='border-2 rounded-md px-2 py-1 border-green-600 text-green-500'>Price Negotibale</div>):(<div className='border-2 rounded-md px-2 py-1 border-red-500 text-red-500'>Price Non Negotibale</div>)}
                            </div>
                        </div>
                ...
                <div className='flex flex-col justify-between h-full'>
                    ...
                    <div className='bg-white rounded-2xl shadow-2xl my-2 h-auto flex flex-col w-full pt-2'>
                        ...
                        <div className='flex flex-row py-2 px-4 items-center'>
                            <div className='text-lg px-2 p text-white bg-[#8A307F] rounded-md shadow-2xl'>
                                ${fullItem.sPrice}
                            </div>
                            ...
                            <div className='pl-2'>
                                {fullItem.isNego=="yes"?(<div className='border-2 rounded-md px-1 py-1 border-green-600 text-green-500 text-xs'>Price Negotibale</div>):(<div className='border-2 rounded-md px-1 py-1 border-red-600 text-red-500 text-xs'>Price Non Negotibale</div>)}
                            </div>
                        </div>
        ...
        {/* Title */}
        <div className='lg:mx-16 text-md bg-[#11d7ac] w-auto h-auto rounded-lg px-2 py-2 shadow-lg text-center text-white '>
            Buy These Products at your earliest convience
        </div>
                            ...
                            <div className='mb-4 shadow-lg h-auto p-4 w-full relative ' id={item._id}>
                                <div className='flex flex-col bg-white h-full justify-between'>
                                    <div className='my-auto'>
                                        <div className='absolute cursor-pointer top-0 right-1 p-2 rounded-full transition-colors duration-1000'>
                                            {wishIds.includes(item._id)?
                                            (
                                                <button className='' onClick={()=>handleWish(item._id,"yes")}>
                                                    <WishList className='transition-colors duration-500' size={clickedWishAnimation==item._id?`${clickedWishSize}`:'24'} color={clickedWishAnimation==item._id?`${clickedWishColor}`:'red'}/>
                                            ...
                                            (
                                                <button className='transition-colors duration-500' onClick={()=>handleWish(item._id,"no")}>
                                    ...
                                    <div className='flex flex-col pt-2'>
                                        ...
                                        <div className='flex flex-row justify-between items-center'>
                                            <div className='flex md:flex-row flex-col'>
                                                ...
                                                <div className='md:pl-2 line-through'>
                                                    {item.oPrice}
                                                </div>
                                            </div>
